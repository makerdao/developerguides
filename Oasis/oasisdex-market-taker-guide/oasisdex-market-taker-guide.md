...
Note that any market between two ERC20 assets can be added to the protocol, so consider iterating through popular cryptocurrencies in `getPayAmount( )` or `getBuyAmount( )`.
